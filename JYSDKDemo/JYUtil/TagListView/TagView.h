...
@property (nonatomic, strong) IBInspectable UIImage *tagBackgroundImage;//图片设置优先级高于颜色设置
@property (nonatomic, strong) IBInspectable UIImage *selectedBackgroundImage;
